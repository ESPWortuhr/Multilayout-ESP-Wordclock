let TRANSLATION_DE_DE = {
	...
	"settings": {
		...
		"brightness": {
			...
			"value-sensor": "Sensor [Lux]",
			"help-offset": "Konfiguration des Helligkeitsoffsets: Dies bestimmt die minimale Helligkeit der LEDs bei 0 Lux Umgebungslicht:\n" +
				"0=LEDs aus, n=LED Helligkeit ist n/255, 255=LEDs haben immer die maximale Helligkeit",
			"value-offset": "Offset (0–255)",
			"help-slope": "Konfiguration der Steilheit: Dies bestimmt den Grad der LED-Helligkeitsänderung bei Änderung des Umgebungslichts.\n" +
				"0=schwache LED-Helligkeitsänderung, 127=neutrale LED-Helligkeitsänderung, 255=starke LED-Helligkeitsänderung",
