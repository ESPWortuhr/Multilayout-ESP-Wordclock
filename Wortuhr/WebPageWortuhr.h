                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            ...
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <div class="pure-control-group">
                                        <label for="brightness-16">Stunde</label><select name="brightness-16" id="brightness-16" size="1">
                                    ...
                                    <div class="pure-control-group">
                                        <label for="brightness-16">Minute</label><select name="brightness-16" id="brightness-16" size="1">
                                        <option value="0">0</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                ...
                <div class="pure-u-1 pure-u-md-1-2">
                    ...
                    <div class="box">
                        ...
                        <form class="pure-form pure-form-aligned">
                            <fieldset>
                                <div class="pure-control-group">
                                    <label for="password">MQTT Serveradresse</label><input id="mqtt_server" type="mqtt_server" placeholder="MQTT Server">
                                </div>
                                <div class="pure-control-group">
                                    <label for="password">MQTT Port</label><input id="mqtt_port" type="mqtt_port" placeholder="MQTT Serverport">
                                </div>
                                <div class="pure-control-group">
                                    <label for="password">MQTT Topic</label><input id="mqtt_topic" type="mqtt_topic" placeholder="MQTT Topic">
                                </div>
                                <div class="pure-controls">
