...
<div id="layout">
    ...
    <div id="menu">
        <div class="pure-menu">
            <a class="pure-menu-heading" href="#">Wortuhr</a>

            <ul class="pure-menu-list">
                <li class="pure-menu-item"><a href="#" class="pure-menu-link" data-navigation="main">Farben</a></li>
                <li class="pure-menu-item"><a href="#" class="pure-menu-link" data-navigation="functions">Funktionen</a></li>
                <li class="pure-menu-item"><a href="#" class="pure-menu-link" data-navigation="settings">Einstellungen</a></li>
                <li class="pure-menu-item"><a href="#" class="pure-menu-link" data-navigation="smart_home">Smart Home</a></li>
                <li class="pure-menu-item"><a href="#" class="pure-menu-link" data-navigation="about">Über</a></li>
            </ul>
        </div>
    </div>
...
const char HTML_Code1[] PROGMEM= R"=====(
...
const char HTML_Code2[] PROGMEM= R"=====(
                </div>
            ...
            <div class="pure-u-24-24 section section-functions">
                ...
                <div class="box functions-settings">
                    ...
                    <div class="pure-g brightness">
                        <div class="pure-u-1 pure-u-md-1-4"><label class="slider-label" for="slider-brightness">Helligkeit <span class="value" id="slider-brightness-value">0</span></label>
                        </div>
                        <div class="pure-u-1 pure-u-md-3-4"><input id="slider-brightness" type="range" min="1" max="10" value="1"></div>
                    </div>
                    <div class="pure-g speed">
                        <div class="pure-u-1 pure-u-md-1-4"><label class="slider-label" for="slider-speed">Geschwindigkeit <span class="value"
                                                                                                                                 id="slider-speed-value">0</span></label></div>
                        <div class="pure-u-1 pure-u-md-3-4"><input id="slider-speed" type="range" min="0" max="40" value="0"></div>
                    </div>
                    <div class="pure-g leds">
                        <div class="pure-u-1 pure-u-md-1-4"><label class="slider-label" for="slider-leds">Anzahl LEDs <span class="value" id="slider-leds-value">0</span></label>
                        </div>
                        <div class="pure-u-1 pure-u-md-3-4"><input id="slider-leds" type="range" min="5" max="100" value="100"></div>
                    </div>
                    <div class="pure-g position">
                        <div class="pure-u-1 pure-u-md-1-4"><label class="slider-label" for="slider-position">Positon <span class="value"
                                                                                                                            id="slider-position-value">0</span></label></div>
            ...
            <div class="pure-u-24-24 section section-settings">
                ...
                <div class="pure-g">
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            <h2>Uhrzeit manuell einstellen</h2>
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <div class="pure-control-group">
                                        <label for="stunde">Stunde</label><select name="stunde" id="stunde" size="1">
                                    ...
                                    <div class="pure-control-group">
                                        <label for="minute">Minute</label><select name="minute" id="minute" size="1">
                                    ...
                                    <div class="pure-controls">
                                        <button id="uhrzeit-button" class="pure-button">Uhrzeit speichern</button>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
...
const char HTML_Code3[] PROGMEM= R"=====(
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            ...
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <div class="pure-control-group">
                                        <label for="owm-api-key">OpenWeatherMap API-Schluessel</label><input id="owm-api-key" type="text" minlength="32" maxlength="32"
                                                                                                             placeholder="API-Schlüssel">
                                    </div>
                                    <div class="pure-control-group">
                                        <label for="owm-city-id">OpenWeatherMap City ID</label><input id="owm-city-id" type="text" minlength="7" maxlength="7"
                                                                                                      placeholder="City ID">
                                    </div>
                                    <div class="pure-controls">
                                        <button id="weather-button" class="pure-button">Daten speichern</button>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
...
const char HTML_Code4[] PROGMEM= R"=====(
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            ...
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <div class="pure-control-group">
                                        <label for="show-minutes">Exklusive Einstellung für die Uhr des Types UHR_169. Sollen bei dieser Uhr die Minuten angezeigt werden
                                            ?</label><select name="show-minutes" id="show-minutes" size="1">
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            ...
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <div class="pure-control-group">
                                        <label for="show-seconds">Exklusive Einstellung für die Uhr des Types UHR_169. Sollen bei dieser Uhr die Sekunden im Rahmen angezeigt werden
                                            ?</label><select name="show-seconds" id="show-seconds" size="1">
                                        <option value="0" selected>Nein</option>
...
const char HTML_Code5[] PROGMEM= R"=====(
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            ...
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <div class="pure-control-group">
                                        <label for="UhrtypeDef">Änderung des Uhrentypes.</label><select name="UhrtypeDef" id="UhrtypeDef" size="1">
                                    ...
                                    <div class="pure-controls">
                                        <button id="UhrtypeDef-button" class="pure-button">UhrtypeDef speichern</button>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            <h2>Sprachoptionen</h2>
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <div class="pure-control-group">
                                        <label for="Sprachvariation0">Um 9:15 ist es...</label><select name="Sprachvariation0" id="Sprachvariation0" size="1">
                                        <option value="0" selected>viertel nach neun</option>
                                        <option value="1">viertel zehn</option>
                                    </select>
                                    </div>
                                    <div class="pure-control-group">
                                        <label for="Sprachvariation1">Um 9:20 ist es...</label><select name="Sprachvariation1" id="Sprachvariation1" size="1">
                                        <option value="0" selected>zwanzig nach neun</option>
                                        <option value="1">zehn vor halb zehn</option>
                                    </select>
                                    </div>
                                    <div class="pure-control-group">
                                        <label for="Sprachvariation2">Um 9:40 ist es...</label><select name="Sprachvariation2" id="Sprachvariation2" size="1">
                                        <option value="0" selected>zwanzig vor zehn</option>
                                        <option value="1">zehn nach halb zehn</option>
                                    </select>
                                    </div>
                                    )=====";

const char HTML_Code6[] PROGMEM= R"=====(
                                    <div class="pure-control-group">
                                        <label for="Sprachvariation3">Um 9:45 ist es...</label><select name="Sprachvariation3" id="Sprachvariation3" size="1">
...
const char HTML_Code7[] PROGMEM= R"=====(
                                    <div class="pure-controls">
                                        <button id="Sprachvariation-button" class="pure-button">Optionen speichern</button>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            <h2>Einstellung des LED-Typs</h2>
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <div class="pure-control-group">
                                        ...
                                        <option value="3">WS2812 RBG</option>
                                        <option value="4">SK6812 RGBW</option>
                                    </select>
                                    </div>
                                    <div class="pure-controls">
                                        <button id="colortype-button" class="pure-button">Colortype speichern</button>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            <h2>Einstellung des LDR</h2>
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <div class="pure-control-group">
                                        <label for="ldr">Aktivieren der LDR Steuerung</label><select name="ldr" id="ldr" size="1">
                                        <option value="0" selected>OFF</option>
                                        <option value="1">ON</option>
                                    </select>
                                    </div>
                                    <div class="pure-control-group">
                                        <label for="ldrCal">24 Uhr</label><select name="ldrCal" id="ldrCal" size="1">
                                    ...
                                    <div class="pure-controls">
                                        <button id="ldr-button" class="pure-button">LDR speichern</button>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            ...
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <legend>
                                    Was soll beim Neustart passieren?
                                    </legend>
                                    <div class="pure-control-group">
                                        <input type="checkbox" id="boot-led-blink" />
                                        <label for="boot-led-blink" class="pure-checkbox">LEDs kurz aufblitzen</label>
                                    </div>
                                    <div class="pure-control-group">
                                        <input type="checkbox" id="boot-led-sweep" />
                                        <label for="boot-led-sweep" class="pure-checkbox">Alle LEDs einmal durchlaufen lassen</label>
                                    </div>
                                    <div class="pure-control-group">
                                    ...
                                    <div class="pure-control-group">
                                        <input type="checkbox" id="boot-show-ip" />
                                        <label for="boot-show-ip" class="pure-checkbox">IP Addresse anzeigen</label>
                                    </div>
                                    <div class="pure-controls">
                                        <button id="boot-button" class="pure-button">Speichern</button>
                                        <button id="reset-button" class="pure-button">Neu Starten</button>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            ...
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <legend>
                                    Neukonfiguration erstellt ein eigenes WLAN.
                                    Mit diesem verbinden, dann kann das Zielnetz ausgewählt werden.
                                    </legend>

                                    <div class="pure-control-group">
                                        <label for="ssid">SSID</label>
					<input id="ssid" type="text" placeholder="SSID" readonly>
                                    </div>
            ...
            <div class="pure-u-24-24 section section-smart_home">
                <div class="header">
                    <h1>Smart Home</h1>
                </div>
                <div class="box">
                ...
                <div class="pure-u-1 pure-u-md-1-2">
                    ...
                    <div class="box">
                        ...
                        <form class="pure-form pure-form-aligned">
                            <fieldset>
                                <div class="pure-control-group">
                                    <label for="MQTT_State">Aktiviere MQTT</label><select name="MQTT_State" id="MQTT_State" size="1">
                                    <option value="0" selected>Off</option>
                                    <option value="1">ON</option>
                                </select>
                                </div>
                                <div class="pure-control-group">
                                    <label for="MQTT_Server">MQTT Serveradresse</label><input id="MQTT_Server" type="MQTT_Server" placeholder="MQTT Server">
                                </div>
                                <div class="pure-control-group">
                                    <label for="MQTT_Port">MQTT Port</label><input id="MQTT_Port" type="MQTT_Port" placeholder="MQTT Serverport">
                                </div>
                                <div class="pure-controls">
                                    <button id="mqtt-button" class="pure-button">MQTT-Daten speichern</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
            ...
            <div class="pure-u-24-24 section section-about">
                ...
                <div class="box">
                    <p>Die Software dieser Wortuhr basiert auf der Wortuhr von <a href="https://web.archive.org/web/20180422160812/http://www.ulrichradig.de/home/index.php/projekte/wort-uhr-neu"> (Stand 2019) Ulrich Radig</a> und wird nun weiterentwickelt von <a
                        ...
                        <a href="https://github.com/Flo455">Flo455</a>, <a href="https://github.com/Elektron79">Elektron79</a>, <a href="https://github.com/tali">tali</a> und <a href="https://github.com/masju1">masju1</a>.</p>
...
<<<<<<< HEAD
<script>!function(e,t){var s=t.getElementById("layout"),n=t.getElementById("menu"),r=t.getElementById("menuLink");function i(e,t){for(var s=e.className.split(/\s+/),n=s.length,r=0;r<n;r++)if(s[r]===t){s.splice(r,1);break}n===s.length&&s.push(t),e.className=s.join(" ")}function o(e){e.preventDefault(),i(s,"active"),i(n,"active"),i(r,"active")}t.addEventListener("click",function(e){return e.target.id===r.id?o(e):-1!==n.className.indexOf("active")?o(e):void 0})}(0,this.document);var websocket,MINI=require("minified"),_=MINI._,$=MINI.$,$$=MINI.$$,EE=MINI.EE,HTML=MINI.HTML,ipEsp="ws://192.168.4.1",debug=!0,command=1,rgb=[[0,0,100,0],[0,10,0,0],[10,0,0,0],[5,5,5,0]],sliderType=0,hell=2,geschw=10,anzahl=100,sleep=0,sleeptime=1,position=100,color=0,h6=100,h8=100,h12=100,h16=100,h18=100,h20=100,h22=100,h24=100,Sprachvariation=[0,0,0,0],ldr=0,showSeconds=0,showMinutes=0,UhrtypeDef=0,colortype=0,MQTT_State=0,MQTT_Port=0,MQTT_Server=0,COMMAND_MODE_WORD_CLOCK=1,COMMAND_MODE_SECONDS=2,COMMAND_MODE_MARQUEE=3,COMMAND_MODE_RAINBOW=4,COMMAND_MODE_CHANGE=5,COMMAND_MODE_COLOR=6,COMMAND_SET_INITIAL_VALUES=20,COMMAND_SET_TIME=30,COMMAND_SET_LANGUAGE_VARIANT=84,COMMAND_SET_MQTT=85,COMMAND_SET_TIME_MANUAL=86,COMMAND_SET_WPS_MODE=87,COMMAND_SET_COLORTYPE=88,COMMAND_SET_UHRTYPE=89,COMMAND_SET_WEATHER_DATA=90,COMMAND_SET_LDR=91,COMMAND_SET_HOSTNAME=92,COMMAND_SET_SETTING_SECOND=93,COMMAND_SET_MINUTE=94,COMMAND_SET_BRIGHTNESS=95,COMMAND_SET_MARQUEE_TEXT=96,COMMAND_SET_TIMESERVER=97,COMMAND_SET_WIFI_DISABLED=98,COMMAND_SET_WIFI_AND_RESTART=99,COMMAND_RESET=100,COMMAND_SET_BOOT=101,COMMAND_BRIGHTNESS=151,COMMAND_SPEED=152,COMMAND_LEDS=153,COMMAND_POSITION=154,COMMAND_REQUEST_CONFIG_VALUES=200,COMMAND_REQUEST_COLOR_VALUES=201,COMMAND_REQUEST_WIFI_LIST=202,COLOR_FOREGROUND=0,COLOR_BACKGROUND=1,COLOR_BORDER=2,COLOR_EFFECT=3,DATA_MARQUEE_TEXT_LENGTH=30,DATA_SSID_TEXT_LENGTH=32,DATA_PASSWORT_TEXT_LENGTH=63,DATA_TIMESERVER_TEXT_LENGTH=16,DATA_MQTTSERVER_TEXT_LENGTH=30,DATA_HOST_TEXT_LENGTH=16;function initConfigValues(){var e=location.host;ipEsp=""!==e?"ws://"+e:"ws://192.168.178.44/",debug=!0,command=1,rgb=[[0,0,100,0],[0,10,0,0],[10,0,0,0],[5,5,5,0]],sliderType=0,hell=2,geschw=10,anzahl=100,sleep=0,sleeptime=1,position=100,anzahl=100,color=0,h6=100,h8=100,h12=100,h16=100,h18=100,h20=100,h22=100,h24=100,ldr=0,Sprachvariation=[0,0,0,0],showSeconds=0,showMinutes=0,UhrtypeDef=0,colortype=0,MQTT_State=0,MQTT_Port=0,MQTT_Server=0,bootLedBlink=0,bootLedSweep=0,bootShowWifi=0,bootShowIP=0}function hexToRgb(e){var t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t?{red:parseInt(t[1],16),green:parseInt(t[2],16),blue:parseInt(t[3],16)}:null}function debugMessage(e,t){!0===debug&&(void 0!==console&&(console.log(e),t&&console.log(t)),$("#output").fill(e))}function initWebsocket(){(websocket=new WebSocket(ipEsp)).onopen=function(e){$("#status").set("+online"),$("#status").set("-offline"),$("#status").set("@value","Online"),$(".status-button").fill("Verbindung trennen"),$(".status-button").set("@value","1"),$("#section-connection-lost").set({$display:"none"}),debugMessage("Die Verbindung mit dem Websocket wurde aufgebaut.",e),sendData(COMMAND_REQUEST_COLOR_VALUES,0,0)},websocket.onclose=function(e){$("#status").set("-online"),$("#status").set("+offline"),$("#status").set("@value","Offline"),$(".status-button").fill("Verbinden"),$(".status-button").set("@value","0"),$("#section-connection-lost").set({$display:"block"}),debugMessage("Die Verbindung mit dem Websocket wurde geschlossen (Code "+e.code+").",e)},websocket.onmessage=function(e){var t=JSON.parse(e.data);debugMessage("Webservice response arrived (Command "+t.command+").",t),"config"===t.command&&($("#ssid").set("value",t.ssid),$("#timeserver").set("value",t.zeitserver),$("#hostname").set("value",t.hostname),$("#marquee").set("value",t.ltext),$("#brightness-6").set("value",t.h6),$("#brightness-8").set("value",t.h8),$("#brightness-12").set("value",t.h12),$("#brightness-16").set("value",t.h16),$("#brightness-18").set("value",t.h18),$("#brightness-20").set("value",t.h20),$("#brightness-22").set("value",t.h22),$("#brightness-24").set("value",t.h24),$("#Sprachvariation0").set("value",t.spv0),$("#Sprachvariation1").set("value",t.spv1),$("#Sprachvariation2").set("value",t.spv2),$("#Sprachvariation3").set("value",t.spv3),$("#ldr").set("value",t.ldr),$("#slider-brightness").set("value",t.hell),$("#slider-speed").set("value",t.geschw),$("#showSeconds").set("value",t.zeige_sek),$("#showMinutes").set("value",t.zeige_min),$("#owm-api-key").set("value",t.apiKey),$("#owm-city-id").set("value",t.cityid),$("#MQTT_Port").set("value",t.MQTT_Port),$("#MQTT_Server").set("value",t.MQTT_Server),$("#MQTT_Topic").set("value",t.MQTT_Topic),$("#UhrtypeDef").set("value",t.UhrtypeDef),$("#colortype").set("value",t.colortype),$("#MQTT_State").set("value",t.MQTT_State),$("#MQTT_Port").set("value",t.MQTT_Port),$("#MQTT_Server").set("value",t.MQTT_Server),$("#boot-led-blink").set("checked",0|t.bootLedBlink),$("#boot-led-sweep").set("checked",0|t.bootLedSweep),$("#boot-show-wifi").set("checked",0|t.bootShowWifi),$("#boot-show-ip").set("checked",0|t.bootShowIP)),"set"===t.command&&(rgb[0][0]=t.rgb00,rgb[0][1]=t.rgb01,rgb[0][2]=t.rgb02,rgb[0][3]=t.rgb03,rgb[1][0]=t.rgb10,rgb[1][1]=t.rgb11,rgb[1][2]=t.rgb12,rgb[1][3]=t.rgb13,rgb[2][0]=t.rgb20,rgb[2][1]=t.rgb21,rgb[2][2]=t.rgb22,rgb[2][3]=t.rgb23,rgb[3][0]=t.rgb30,rgb[3][1]=t.rgb31,rgb[3][2]=t.rgb32,rgb[3][3]=t.rgb33,hell=t.hell,geschw=t.geschw,colortype=t.colortype,setSliders()),"wlan"===t.command&&(document.getElementById("wlanlist").innerHTML=t.list)},websocket.onerror=function(e){debugMessage("Bei der Verbindung mit dem Websocket ist ein Fehler aufgetreten.",e)}}function getSliders(){rgb[sliderType][0]=$("#slider-red").get("value"),rgb[sliderType][1]=$("#slider-green").get("value"),rgb[sliderType][2]=$("#slider-blue").get("value"),"4"===colortype&&(rgb[sliderType][3]=$("#slider-white").get("value")),hell=$("#slider-brightness").get("value"),geschw=$("#slider-speed").get("value"),anzahl=$("#slider-leds").get("value"),position=$("#slider-position").get("value")}function setSliders(){$("#slider-red").set("value",rgb[sliderType][0]),$("#slider-green").set("value",rgb[sliderType][1]),$("#slider-blue").set("value",rgb[sliderType][2]),$("#slider-white").set("value",rgb[sliderType][3]),$("#slider-red-value").fill(rgb[sliderType][0]),$("#slider-green-value").fill(rgb[sliderType][1]),$("#slider-blue-value").fill(rgb[sliderType][2]),$("#slider-white-value").fill(rgb[sliderType][3]),$("#slider-brightness").set("value",hell),$("#slider-speed").set("value",geschw),$("#slider-leds").set("value",anzahl),$("#slider-position").set("value",position),$("#slider-brightness-value").fill(hell),$("#slider-speed-value").fill(geschw),$("#slider-leds-value").fill(anzahl),$("#slider-position-value").fill(position),$("#color-area")[0].style.backgroundColor="rgb("+rgb[sliderType][0]+","+rgb[sliderType][1]+","+rgb[sliderType][2]+")"}function nstr5(e){return e<10?e="00"+e:e<100?e="0"+e:e<1e3?e="0"+e:e<1e4&&(e="0"+e),e}function nstr(e){return e<10?e="00"+e:e<100&&(e="0"+e),e}function getPaddedString(e,t){for(;e.length<t;)e+=" ";return e}function sendData(e,t,s){var n=nstr(e)+nstr(t)+nstr(s)+nstr(rgb[COLOR_FOREGROUND][0])+nstr(rgb[COLOR_FOREGROUND][1])+nstr(rgb[COLOR_FOREGROUND][2])+nstr(rgb[COLOR_FOREGROUND][3])+nstr(rgb[COLOR_BACKGROUND][0])+nstr(rgb[COLOR_BACKGROUND][1])+nstr(rgb[COLOR_BACKGROUND][2])+nstr(rgb[COLOR_BACKGROUND][3])+nstr(rgb[COLOR_FOREGROUND][0])+nstr(rgb[COLOR_FOREGROUND][1])+nstr(rgb[COLOR_FOREGROUND][2])+nstr(rgb[COLOR_FOREGROUND][3])+nstr(rgb[COLOR_FOREGROUND][0])+nstr(rgb[COLOR_FOREGROUND][1])+nstr(rgb[COLOR_FOREGROUND][2])+nstr(rgb[COLOR_FOREGROUND][3])+nstr(hell)+nstr(geschw)+nstr(anzahl)+nstr(position)+"999";websocket.send(n),debugMessage("Send data: ",n)}function CMDtoData(e,t,s){return nstr(e)+nstr(t)+nstr(s)}$.ready(function(){initConfigValues(),setSliders(),initWebsocket(),$(".status-button").on("click",function(){var e=$(this).get("value");return"1"===e?(e=0,$("#status").fill("Verbinden ..."),$(".status-button").set("value",e),websocket.close()):(e=1,$("#status").fill("Verbinden ..."),$(".status-button").set("value",e),initWebsocket()),!1}),$("#_clock").on("click",function(){var e=new Date,t=e.getTimezoneOffset();t=t/60*-1;var s=e.getTime()/1e3,n=CMDtoData(COMMAND_SET_TIME,0,0);n+=getPaddedString(nstr(t)+s,21),debugMessage("Clock data: ",n+="999"),websocket.send(n)}),$("input[name='color-mode']").on("change",function(){switch($(this).get("value")){case"foreground":sliderType=COLOR_FOREGROUND;break;case"background":sliderType=COLOR_BACKGROUND}setSliders()}),$("a[class~='pure-menu-link']").on("click",function(){var e=$(this)[0].dataset.navigation;$(".pure-menu-link").set("-active"),$(this).set("+active"),"settings"===e&&sendData(COMMAND_REQUEST_CONFIG_VALUES,0,0),$(".section").set({$display:"none"}),$(".section-"+e).set({$display:"block"})}),$("input[name='mode']").on("change",function(){var e=$(this).get("id"),t=!1,s=!1;"mode-wordclock"===e&&(sliderType=COLOR_FOREGROUND,command=COMMAND_MODE_WORD_CLOCK),"mode-color"===e&&(sliderType=COLOR_FOREGROUND,command=COMMAND_MODE_COLOR),"mode-seconds"===e&&(sliderType=COLOR_FOREGROUND,command=COMMAND_MODE_SECONDS),"mode-marquee"===e&&(s=!0,sliderType=COLOR_FOREGROUND,command=COMMAND_MODE_MARQUEE),"mode-rainbow"===e&&(t=!0,s=!0,command=COMMAND_MODE_RAINBOW),"mode-change"===e&&(t=!0,s=!0,command=COMMAND_MODE_CHANGE),!0===t?$(".brightness").set({$display:"block"}):$(".brightness").set({$display:"none"}),!0===s?$(".speed").set({$display:"block"}):$(".speed").set({$display:"none"}),t||s?$(".functions-settings").set({$display:"block"}):$(".functions-settings").set({$display:"none"}),sendData(command,0,0),setSliders()}),$(".quick-color").on("click",function(e){var t=hexToRgb($(this)[0].dataset.color);return rgb[sliderType][0]=t.red,rgb[sliderType][1]=t.green,rgb[sliderType][2]=t.blue,rgb[sliderType][3]=0,hell=$("#slider-brightness").get("value"),geschw=$("#slider-speed").get("value"),anzahl=$("#slider-leds").get("value"),position=$("#slider-position").get("value"),setSliders(),sendData(command,0,0),setSliders(),!1}),$("[id*='slider']").onChange(function(e){var t=$(this).get("id");return 0===sleep&&(getSliders(),"slider-red"===t&&sendData(command,1,0),"slider-green"===t&&sendData(command,1,0),"slider-blue"===t&&sendData(command,1,0),"slider-white"===t&&sendData(command,1,0),"slider-brightness"===t&&sendData(COMMAND_BRIGHTNESS,0,0),"slider-speed"===t&&sendData(COMMAND_SPEED,0,0),"slider-leds"===t&&sendData(COMMAND_LEDS,0,0),"slider-position"===t&&sendData(COMMAND_POSITION,0,0),setSliders(),sleep=1,sleeptime=20,setTimeout(function(){sleep=0},sleeptime)),!1}),$("#initial-values-button").on("click",function(){sendData(COMMAND_SET_INITIAL_VALUES,0,0)}),$("#wifi-button").on("click",function(){return sendData(COMMAND_SET_WIFI_AND_RESTART,0,0),debugMessage("WLAN wird neu konfiguriert",data),!1}),$("#_wlanscan").on("click",function(){var e=CMDtoData(COMMAND_REQUEST_WIFI_LIST,0,0);return websocket.send(e),document.getElementById("wlanlist").innerHTML="<div>WLAN Netzwerke werden gesucht</div>",!1}),$("#timeserver-button").on("click",function(){var e=$("#timeserver").get("value"),t=CMDtoData(COMMAND_SET_TIMESERVER,0,0);return t+=getPaddedString(e,DATA_TIMESERVER_TEXT_LENGTH),t+="999",websocket.send(t),debugMessage("Zeitserver wurde neu konfiguriert",t),!1}),$("#marquee-button").on("click",function(){var e=$("#marquee").get("value"),t=CMDtoData(COMMAND_SET_MARQUEE_TEXT,0,0);t+=getPaddedString(e,DATA_MARQUEE_TEXT_LENGTH),t+="999",websocket.send(t),debugMessage("Lauftext wurde neu konfiguriert",t)}),$("#brightness-button").on("click",function(){h6=$("#brightness-6").get("value"),h8=$("#brightness-8").get("value"),h12=$("#brightness-12").get("value"),h16=$("#brightness-16").get("value"),h18=$("#brightness-18").get("value"),h20=$("#brightness-20").get("value"),h22=$("#brightness-22").get("value"),h24=$("#brightness-24").get("value");var e=CMDtoData(COMMAND_SET_BRIGHTNESS,0,0);e+=nstr(h6)+nstr(h8)+nstr(h12)+nstr(h16)+nstr(h18)+nstr(h20)+nstr(h22)+nstr(h24)+"999",websocket.send(e),debugMessage("Helligkeit wurde neu konfiguriert",e)}),$("#weather-button").on("click",function(){var e=$("#owm-api-key").get("value"),t=$("#owm-city-id").get("value"),s=CMDtoData(COMMAND_SET_WEATHER_DATA,0,0);s+=t+" "+e+"  999",websocket.send(s),debugMessage("OpenWeatherMap Zugangsdaten wurden konfiguriert",s)}),$("#show-minutesbutton").on("click",function(){var e=$("#show-minutes").get("value"),t=CMDtoData(COMMAND_SET_MINUTE,0,0);t+=e+"  999",websocket.send(t),debugMessage("Minutenanzeige wurde neu konfiguriert",t)}),$("#show-seconds-button").on("click",function(){var e=$("#show-seconds").get("value"),t=CMDtoData(COMMAND_SET_SETTING_SECOND,0,0);t+=e+"  999",websocket.send(t),debugMessage("Sekundenanzeige wurde neu konfiguriert",t)}),$("#UhrtypeDef-button").on("click",function(){var e=$("#UhrtypeDef").get("value"),t=CMDtoData(COMMAND_SET_UHRTYPE,0,0);t+=e+"  999",websocket.send(t),debugMessage("UhrtypeDef wurde neu konfiguriert",t)}),$("#colortype-button").on("click",function(){colortype=$("#colortype").get("value");var e=CMDtoData(COMMAND_SET_COLORTYPE,0,0);e+=colortype+"  999",websocket.send(e),debugMessage("Colortype wurde neu konfiguriert",e)}),$("#ldr-button").on("click",function(){ldr=$("#ldr").get("value");var e=CMDtoData(COMMAND_SET_LDR,0,0);e+=nstr(ldr)+"000  999",websocket.send(e),debugMessage("LDR Steuerung wurde konfiguriert",e)}),$("#hostname-button").on("click",function(){var e=$("#hostname").get("value"),t=CMDtoData(COMMAND_SET_HOSTNAME,0,0);t+=getPaddedString(e,DATA_HOST_TEXT_LENGTH),t+="999",websocket.send(t),debugMessage("Hostname wurde neu konfiguriert",t)}),$("#boot-button").on("click",function(){bootLedBlink=0|$("#boot-led-blink").get("checked"),bootLedSweep=0|$("#boot-led-sweep").get("checked"),bootShowWifi=0|$("#boot-show-wifi").get("checked"),bootShowIP=0|$("#boot-show-ip").get("checked");var e=CMDtoData(COMMAND_SET_BOOT,0,0);e+=nstr(bootLedBlink)+nstr(bootLedSweep)+nstr(bootShowWifi)+nstr(bootShowIP)+"999",websocket.send(e),debugMessage("Bootoptionen wurden neu konfiguriert",e)}),$("#disable-button").on("click",function(){sendData(COMMAND_SET_WIFI_DISABLED,0,0)}),$("#wps-button").on("click",function(){sendData(COMMAND_SET_WPS_MODE,0,0)}),$("#reset-button").on("click",function(){sendData(COMMAND_RESET,0,0)}),$("#uhrzeit-button").on("click",function(){var e=$("#stunde").get("value"),t=$("#minute").get("value"),s=CMDtoData(COMMAND_SET_TIME_MANUAL,0,0);s+=nstr(e)+nstr(t)+"999",websocket.send(s),debugMessage("Uhrzeit wurde manuell konfiguriert",s)}),$("#mqtt-button").on("click",function(){MQTT_State=$("#mqtt_state").get("value"),MQTT_Port=$("#mqtt_port").get("value"),MQTT_Server=$("#mqtt_server").get("value");var e=CMDtoData(COMMAND_SET_MQTT,0,0);e+=nstr(MQTT_State)+nstr5(MQTT_Port)+getPaddedString(MQTT_Server,DATA_MQTTSERVER_TEXT_LENGTH),websocket.send(e),debugMessage("MQTT Server wurde konfiguriert",e)}),$("#Sprachvariation-button").on("click",function(){var e=CMDtoData(COMMAND_SET_LANGUAGE_VARIANT,0,0);Sprachvariation[0]=$("#Sprachvariation0").get("value"),Sprachvariation[1]=$("#Sprachvariation1").get("value"),Sprachvariation[2]=$("#Sprachvariation2").get("value"),Sprachvariation[3]=$("#Sprachvariation3").get("value"),e+=nstr(Sprachvariation[0])+nstr(Sprachvariation[1])+nstr(Sprachvariation[2])+nstr(Sprachvariation[3])+"999",websocket.send(e),debugMessage("Sprachvariation wurde konfiguriert",e)})});</script>
=======
<script>!function(e,t){var s=t.getElementById("layout"),n=t.getElementById("menu"),r=t.getElementById("menuLink");function a(e,t){for(var s=e.className.split(/\s+/),n=s.length,r=0;r<n;r++)if(s[r]===t){s.splice(r,1);break}n===s.length&&s.push(t),e.className=s.join(" ")}function i(e){e.preventDefault(),a(s,"active"),a(n,"active"),a(r,"active")}t.addEventListener("click",function(e){return e.target.id===r.id?i(e):-1!==n.className.indexOf("active")?i(e):void 0})}(0,this.document);var websocket,MINI=require("minified"),_=MINI._,$=MINI.$,$$=MINI.$$,EE=MINI.EE,HTML=MINI.HTML,ipEsp="ws://192.168.4.1",debug=!0,command=1,rgb=[[0,0,100,0],[0,10,0,0],[10,0,0,0],[5,5,5,0]],sliderType=0,hell=2,geschw=10,anzahl=100,sleep=0,sleeptime=1,position=100,color=0,h6=100,h8=100,h12=100,h16=100,h18=100,h20=100,h22=100,h24=100,Sprachvariation=[0,0,0,0],ldr=0,ldrCal=0,showSeconds=0,showMinutes=0,UhrtypeDef=0,colortype=0,MQTT_State=0,MQTT_Port=0,MQTT_Server=0,COMMAND_MODE_WORD_CLOCK=1,COMMAND_MODE_SECONDS=2,COMMAND_MODE_MARQUEE=3,COMMAND_MODE_RAINBOW=4,COMMAND_MODE_CHANGE=5,COMMAND_MODE_COLOR=6,COMMAND_SET_INITIAL_VALUES=20,COMMAND_SET_TIME=30,COMMAND_SET_LANGUAGE_VARIANT=84,COMMAND_SET_MQTT=85,COMMAND_SET_TIME_MANUAL=86,COMMAND_SET_WPS_MODE=87,COMMAND_SET_COLORTYPE=88,COMMAND_SET_UHRTYPE=89,COMMAND_SET_WEATHER_DATA=90,COMMAND_SET_LDR=91,COMMAND_SET_HOSTNAME=92,COMMAND_SET_SETTING_SECOND=93,COMMAND_SET_MINUTE=94,COMMAND_SET_BRIGHTNESS=95,COMMAND_SET_MARQUEE_TEXT=96,COMMAND_SET_TIMESERVER=97,COMMAND_SET_WIFI_DISABLED=98,COMMAND_SET_WIFI_AND_RESTART=99,COMMAND_RESET=100,COMMAND_BRIGHTNESS=151,COMMAND_SPEED=152,COMMAND_LEDS=153,COMMAND_POSITION=154,COMMAND_REQUEST_CONFIG_VALUES=200,COMMAND_REQUEST_COLOR_VALUES=201,COMMAND_REQUEST_WIFI_LIST=202,COLOR_FOREGROUND=0,COLOR_BACKGROUND=1,COLOR_BORDER=2,COLOR_EFFECT=3,DATA_MARQUEE_TEXT_LENGTH=30,DATA_SSID_TEXT_LENGTH=32,DATA_PASSWORT_TEXT_LENGTH=63,DATA_TIMESERVER_TEXT_LENGTH=16,DATA_MQTTSERVER_TEXT_LENGTH=30,DATA_HOST_TEXT_LENGTH=16;function initConfigValues(){var e=location.host;ipEsp=""!==e?"ws://"+e:"ws://192.168.178.44/",debug=!0,command=1,rgb=[[0,0,100,0],[0,10,0,0],[10,0,0,0],[5,5,5,0]],sliderType=0,hell=2,geschw=10,anzahl=100,sleep=0,sleeptime=1,position=100,anzahl=100,color=0,h6=100,h8=100,h12=100,h16=100,h18=100,h20=100,h22=100,h24=100,ldr=0,ldrCal=10,Sprachvariation=[0,0,0,0],showSeconds=0,showMinutes=0,UhrtypeDef=0,colortype=0,MQTT_State=0,MQTT_Port=0,MQTT_Server=0}function hexToRgb(e){var t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t?{red:parseInt(t[1],16),green:parseInt(t[2],16),blue:parseInt(t[3],16)}:null}function debugMessage(e,t){!0===debug&&(void 0!==console&&(console.log(e),t&&console.log(t)),$("#output").fill(e))}function initWebsocket(){(websocket=new WebSocket(ipEsp)).onopen=function(e){$("#status").set("+online"),$("#status").set("-offline"),$("#status").set("@value","Online"),$(".status-button").fill("Verbindung trennen"),$(".status-button").set("@value","1"),$("#section-connection-lost").set({$display:"none"}),debugMessage("Die Verbindung mit dem Websocket wurde aufgebaut.",e),sendData(COMMAND_REQUEST_COLOR_VALUES,0,0)},websocket.onclose=function(e){$("#status").set("-online"),$("#status").set("+offline"),$("#status").set("@value","Offline"),$(".status-button").fill("Verbinden"),$(".status-button").set("@value","0"),$("#section-connection-lost").set({$display:"block"}),debugMessage("Die Verbindung mit dem Websocket wurde geschlossen (Code "+e.code+").",e)},websocket.onmessage=function(e){var t=JSON.parse(e.data);debugMessage("Webservice response arrived (Command "+t.command+").",t),"config"===t.command&&($("#ssid").set("value",t.ssid),$("#timeserver").set("value",t.zeitserver),$("#hostname").set("value",t.hostname),$("#marquee").set("value",t.ltext),$("#brightness-6").set("value",t.h6),$("#brightness-8").set("value",t.h8),$("#brightness-12").set("value",t.h12),$("#brightness-16").set("value",t.h16),$("#brightness-18").set("value",t.h18),$("#brightness-20").set("value",t.h20),$("#brightness-22").set("value",t.h22),$("#brightness-24").set("value",t.h24),$("#Sprachvariation0").set("value",t.spv0),$("#Sprachvariation1").set("value",t.spv1),$("#Sprachvariation2").set("value",t.spv2),$("#Sprachvariation3").set("value",t.spv3),$("#ldr").set("value",t.ldr),$("#ldrCal").set("value",t.ldrCal),$("#slider-brightness").set("value",t.hell),$("#slider-speed").set("value",t.geschw),$("#showSeconds").set("value",t.zeige_sek),$("#showMinutes").set("value",t.zeige_min),$("#owm-api-key").set("value",t.apiKey),$("#owm-city-id").set("value",t.cityid),$("#MQTT_Port").set("value",t.MQTT_Port),$("#MQTT_Server").set("value",t.MQTT_Server),$("#MQTT_Topic").set("value",t.MQTT_Topic),$("#UhrtypeDef").set("value",t.UhrtypeDef),$("#colortype").set("value",t.colortype),$("#MQTT_State").set("value",t.MQTT_State),$("#MQTT_Port").set("value",t.MQTT_Port),$("#MQTT_Server").set("value",t.MQTT_Server)),"set"===t.command&&(rgb[0][0]=t.rgb00,rgb[0][1]=t.rgb01,rgb[0][2]=t.rgb02,rgb[0][3]=t.rgb03,rgb[1][0]=t.rgb10,rgb[1][1]=t.rgb11,rgb[1][2]=t.rgb12,rgb[1][3]=t.rgb13,rgb[2][0]=t.rgb20,rgb[2][1]=t.rgb21,rgb[2][2]=t.rgb22,rgb[2][3]=t.rgb23,rgb[3][0]=t.rgb30,rgb[3][1]=t.rgb31,rgb[3][2]=t.rgb32,rgb[3][3]=t.rgb33,hell=t.hell,geschw=t.geschw,colortype=t.colortype,setSliders()),"wlan"===t.command&&(document.getElementById("wlanlist").innerHTML=t.list)},websocket.onerror=function(e){debugMessage("Bei der Verbindung mit dem Websocket ist ein Fehler aufgetreten.",e)}}function getSliders(){rgb[sliderType][0]=$("#slider-red").get("value"),rgb[sliderType][1]=$("#slider-green").get("value"),rgb[sliderType][2]=$("#slider-blue").get("value"),"4"===colortype&&(rgb[sliderType][3]=$("#slider-white").get("value")),hell=$("#slider-brightness").get("value"),geschw=$("#slider-speed").get("value"),anzahl=$("#slider-leds").get("value"),position=$("#slider-position").get("value")}function setSliders(){$("#slider-red").set("value",rgb[sliderType][0]),$("#slider-green").set("value",rgb[sliderType][1]),$("#slider-blue").set("value",rgb[sliderType][2]),$("#slider-white").set("value",rgb[sliderType][3]),$("#slider-red-value").fill(rgb[sliderType][0]),$("#slider-green-value").fill(rgb[sliderType][1]),$("#slider-blue-value").fill(rgb[sliderType][2]),$("#slider-white-value").fill(rgb[sliderType][3]),$("#slider-brightness").set("value",hell),$("#slider-speed").set("value",geschw),$("#slider-leds").set("value",anzahl),$("#slider-position").set("value",position),$("#slider-brightness-value").fill(hell),$("#slider-speed-value").fill(geschw),$("#slider-leds-value").fill(anzahl),$("#slider-position-value").fill(position),$("#color-area")[0].style.backgroundColor="rgb("+rgb[sliderType][0]+","+rgb[sliderType][1]+","+rgb[sliderType][2]+")"}function nstr5(e){return e<10?e="00"+e:e<100?e="0"+e:e<1e3?e="0"+e:e<1e4&&(e="0"+e),e}function nstr(e){return e<10?e="00"+e:e<100&&(e="0"+e),e}function getPaddedString(e,t){for(;e.length<t;)e+=" ";return e}function sendData(e,t,s){var n=nstr(e)+nstr(t)+nstr(s)+nstr(rgb[COLOR_FOREGROUND][0])+nstr(rgb[COLOR_FOREGROUND][1])+nstr(rgb[COLOR_FOREGROUND][2])+nstr(rgb[COLOR_FOREGROUND][3])+nstr(rgb[COLOR_BACKGROUND][0])+nstr(rgb[COLOR_BACKGROUND][1])+nstr(rgb[COLOR_BACKGROUND][2])+nstr(rgb[COLOR_BACKGROUND][3])+nstr(rgb[COLOR_FOREGROUND][0])+nstr(rgb[COLOR_FOREGROUND][1])+nstr(rgb[COLOR_FOREGROUND][2])+nstr(rgb[COLOR_FOREGROUND][3])+nstr(rgb[COLOR_FOREGROUND][0])+nstr(rgb[COLOR_FOREGROUND][1])+nstr(rgb[COLOR_FOREGROUND][2])+nstr(rgb[COLOR_FOREGROUND][3])+nstr(hell)+nstr(geschw)+nstr(anzahl)+nstr(position)+"999";websocket.send(n),debugMessage("Send data: ",n)}function CMDtoData(e,t,s){return nstr(e)+nstr(t)+nstr(s)}$.ready(function(){initConfigValues(),setSliders(),initWebsocket(),$(".status-button").on("click",function(){var e=$(this).get("value");return"1"===e?(e=0,$("#status").fill("Verbinden ..."),$(".status-button").set("value",e),websocket.close()):(e=1,$("#status").fill("Verbinden ..."),$(".status-button").set("value",e),initWebsocket()),!1}),$("#_clock").on("click",function(){var e=new Date,t=e.getTimezoneOffset();t=t/60*-1;var s=e.getTime()/1e3,n=CMDtoData(COMMAND_SET_TIME,0,0);n+=getPaddedString(nstr(t)+s,21),debugMessage("Clock data: ",n+="999"),websocket.send(n)}),$("input[name='color-mode']").on("change",function(){switch($(this).get("value")){case"foreground":sliderType=COLOR_FOREGROUND;break;case"background":sliderType=COLOR_BACKGROUND}setSliders()}),$("a[class~='pure-menu-link']").on("click",function(){var e=$(this)[0].dataset.navigation;$(".pure-menu-link").set("-active"),$(this).set("+active"),"settings"===e&&sendData(COMMAND_REQUEST_CONFIG_VALUES,0,0),$(".section").set({$display:"none"}),$(".section-"+e).set({$display:"block"})}),$("input[name='mode']").on("change",function(){var e=$(this).get("id"),t=!1,s=!1;"mode-wordclock"===e&&(sliderType=COLOR_FOREGROUND,command=COMMAND_MODE_WORD_CLOCK),"mode-color"===e&&(sliderType=COLOR_FOREGROUND,command=COMMAND_MODE_COLOR),"mode-seconds"===e&&(sliderType=COLOR_FOREGROUND,command=COMMAND_MODE_SECONDS),"mode-marquee"===e&&(s=!0,sliderType=COLOR_FOREGROUND,command=COMMAND_MODE_MARQUEE),"mode-rainbow"===e&&(t=!0,s=!0,command=COMMAND_MODE_RAINBOW),"mode-change"===e&&(t=!0,s=!0,command=COMMAND_MODE_CHANGE),!0===t?$(".brightness").set({$display:"block"}):$(".brightness").set({$display:"none"}),!0===s?$(".speed").set({$display:"block"}):$(".speed").set({$display:"none"}),t||s?$(".functions-settings").set({$display:"block"}):$(".functions-settings").set({$display:"none"}),sendData(command,0,0),setSliders()}),$(".quick-color").on("click",function(e){var t=hexToRgb($(this)[0].dataset.color);return rgb[sliderType][0]=t.red,rgb[sliderType][1]=t.green,rgb[sliderType][2]=t.blue,rgb[sliderType][3]=0,hell=$("#slider-brightness").get("value"),geschw=$("#slider-speed").get("value"),anzahl=$("#slider-leds").get("value"),position=$("#slider-position").get("value"),setSliders(),sendData(command,0,0),setSliders(),!1}),$("[id*='slider']").onChange(function(e){var t=$(this).get("id");return 0===sleep&&(getSliders(),"slider-red"===t&&sendData(command,1,0),"slider-green"===t&&sendData(command,1,0),"slider-blue"===t&&sendData(command,1,0),"slider-white"===t&&sendData(command,1,0),"slider-brightness"===t&&sendData(COMMAND_BRIGHTNESS,0,0),"slider-speed"===t&&sendData(COMMAND_SPEED,0,0),"slider-leds"===t&&sendData(COMMAND_LEDS,0,0),"slider-position"===t&&sendData(COMMAND_POSITION,0,0),setSliders(),sleep=1,sleeptime=20,setTimeout(function(){sleep=0},sleeptime)),!1}),$("#initial-values-button").on("click",function(){sendData(COMMAND_SET_INITIAL_VALUES,0,0)}),$("#wifi-button").on("click",function(){var e=$("#ssid").get("value"),t=$("#password").get("value"),s=CMDtoData(COMMAND_SET_WIFI_AND_RESTART,0,0);return s+=getPaddedString(e,DATA_SSID_TEXT_LENGTH),s+=getPaddedString(t,DATA_PASSWORT_TEXT_LENGTH),s+="999",websocket.send(s),debugMessage("WLAN wurde neu konfiguriert",s),!1}),$("#_wlanscan").on("click",function(){var e=CMDtoData(COMMAND_REQUEST_WIFI_LIST,0,0);return websocket.send(e),document.getElementById("wlanlist").innerHTML="<div>WLAN Netzwerke werden gesucht</div>",!1}),$("#timeserver-button").on("click",function(){var e=$("#timeserver").get("value"),t=CMDtoData(COMMAND_SET_TIMESERVER,0,0);return t+=getPaddedString(e,DATA_TIMESERVER_TEXT_LENGTH),t+="999",websocket.send(t),debugMessage("Zeitserver wurde neu konfiguriert",t),!1}),$("#marquee-button").on("click",function(){var e=$("#marquee").get("value"),t=CMDtoData(COMMAND_SET_MARQUEE_TEXT,0,0);t+=getPaddedString(e,DATA_MARQUEE_TEXT_LENGTH),t+="999",websocket.send(t),debugMessage("Lauftext wurde neu konfiguriert",t)}),$("#brightness-button").on("click",function(){h6=$("#brightness-6").get("value"),h8=$("#brightness-8").get("value"),h12=$("#brightness-12").get("value"),h16=$("#brightness-16").get("value"),h18=$("#brightness-18").get("value"),h20=$("#brightness-20").get("value"),h22=$("#brightness-22").get("value"),h24=$("#brightness-24").get("value");var e=CMDtoData(COMMAND_SET_BRIGHTNESS,0,0);e+=nstr(h6)+nstr(h8)+nstr(h12)+nstr(h16)+nstr(h18)+nstr(h20)+nstr(h22)+nstr(h24)+"999",websocket.send(e),debugMessage("Helligkeit wurde neu konfiguriert",e)}),$("#weather-button").on("click",function(){var e=$("#owm-api-key").get("value"),t=$("#owm-city-id").get("value"),s=CMDtoData(COMMAND_SET_WEATHER_DATA,0,0);s+=t+" "+e+"  999",websocket.send(s),debugMessage("OpenWeatherMap Zugangsdaten wurden konfiguriert",s)}),$("#show-minutesbutton").on("click",function(){var e=$("#show-minutes").get("value"),t=CMDtoData(COMMAND_SET_MINUTE,0,0);t+=e+"  999",websocket.send(t),debugMessage("Minutenanzeige wurde neu konfiguriert",t)}),$("#show-seconds-button").on("click",function(){var e=$("#show-seconds").get("value"),t=CMDtoData(COMMAND_SET_SETTING_SECOND,0,0);t+=e+"  999",websocket.send(t),debugMessage("Sekundenanzeige wurde neu konfiguriert",t)}),$("#UhrtypeDef-button").on("click",function(){var e=$("#UhrtypeDef").get("value"),t=CMDtoData(COMMAND_SET_UHRTYPE,0,0);t+=e+"  999",websocket.send(t),debugMessage("UhrtypeDef wurde neu konfiguriert",t)}),$("#colortype-button").on("click",function(){colortype=$("#colortype").get("value");var e=CMDtoData(COMMAND_SET_COLORTYPE,0,0);e+=colortype+"  999",websocket.send(e),debugMessage("Colortype wurde neu konfiguriert",e)}),$("#ldr-button").on("click",function(){ldr=$("#ldr").get("value"),ldrCal=$("#ldrCal").get("value");var e=CMDtoData(COMMAND_SET_LDR,0,0);e+=nstr(ldr)+nstr(ldrCal)+"  999",websocket.send(e),debugMessage("LDR Steuerung wurde konfiguriert",e)}),$("#host-button").on("click",function(){var e=$("#host").get("value"),t=CMDtoData(COMMAND_SET_HOSTNAME,0,0);t+=getPaddedString(e,DATA_HOST_TEXT_LENGTH),t+="999",websocket.send(t),debugMessage("Hostname wurde neu konfiguriert",t)}),$("#disable-button").on("click",function(){sendData(COMMAND_SET_WIFI_DISABLED,0,0)}),$("#wps-button").on("click",function(){sendData(COMMAND_SET_WPS_MODE,0,0)}),$("#reset-button").on("click",function(){sendData(COMMAND_RESET,0,0)}),$("#uhrzeit-button").on("click",function(){var e=$("#stunde").get("value"),t=$("#minute").get("value"),s=CMDtoData(COMMAND_SET_TIME_MANUAL,0,0);s+=nstr(e)+nstr(t)+"999",websocket.send(s),debugMessage("Uhrzeit wurde manuell konfiguriert",s)}),$("#mqtt-button").on("click",function(){MQTT_State=$("#mqtt_state").get("value"),MQTT_Port=$("#mqtt_port").get("value"),MQTT_Server=$("#mqtt_server").get("value");var e=CMDtoData(COMMAND_SET_MQTT,0,0);e+=nstr(MQTT_State)+nstr5(MQTT_Port)+getPaddedString(MQTT_Server,DATA_MQTTSERVER_TEXT_LENGTH),websocket.send(e),debugMessage("MQTT Server wurde konfiguriert",e)}),$("#Sprachvariation-button").on("click",function(){var e=CMDtoData(COMMAND_SET_LANGUAGE_VARIANT,0,0);Sprachvariation[0]=$("#Sprachvariation0").get("value"),Sprachvariation[1]=$("#Sprachvariation1").get("value"),Sprachvariation[2]=$("#Sprachvariation2").get("value"),Sprachvariation[3]=$("#Sprachvariation3").get("value"),e+=nstr(Sprachvariation[0])+nstr(Sprachvariation[1])+nstr(Sprachvariation[2])+nstr(Sprachvariation[3])+"999",websocket.send(e),debugMessage("Sprachvariation wurde konfiguriert",e)})});</script>
>>>>>>> origin
...
const char* const html_code[] PROGMEM = {HTML_Code0,HTML_Code1,HTML_Code2,HTML_Code3,HTML_Code4,HTML_Code5,HTML_Code6,HTML_Code7};

const uint32_t HTML_Size[] = {sizeof(HTML_Code0),sizeof(HTML_Code1),sizeof(HTML_Code2),sizeof(HTML_Code3),sizeof(HTML_Code4),sizeof(HTML_Code5),sizeof(HTML_Code6),sizeof(HTML_Code7)};
