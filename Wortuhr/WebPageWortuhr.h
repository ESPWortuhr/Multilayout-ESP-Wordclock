...
const char HTML_Code5[] PROGMEM= R"=====(
            ...
            <div class="pure-u-24-24 section section-smart_home">
                ...
                <div class="box">
                    <h2>Smart Home</h2>
                    <p>Die Software der Wordclock bietet die Möglichkeit der Steuerung über die MQTT Schnittstelle. Diese Funktion ist noch experiemtell und wird stetig erweitert.</p>
                </div>
                    ...
                    <div class="box">
                        ...
                        <form class="pure-form pure-form-aligned">
                            <fieldset>
                                ...
                                <div class="pure-control-group">
                                    <label for="mqtt_topic">MQTT Topic</label><input id="mqtt_topic" type="mqtt_topic" placeholder="MQTT Topic">
                                </div>
                                <div class="pure-controls">
