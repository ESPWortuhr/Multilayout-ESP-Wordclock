...
const char index_html_body_mid[] PROGMEM = R"=====(
				</div>
				<div class="box">
					<h2>Schnellfarben</h2>
...
const char Switches_UHR242[] PROGMEM = R"=====(
					<div class="pure-u-1 pure-u-md-1-2">
...
const char Switches_UHR169[] PROGMEM = R"=====(
					<div class="pure-u-1 pure-u-md-1-2">
...
const char index_html_body_rest[] PROGMEM = R"=====(
					...
					<div class="pure-u-1 pure-u-md-1-2">
						...
						<div class="box">
							...
							<form class="pure-form pure-form-aligned">
								<fieldset>
									<div class="pure-controls">
                                        <label for="disable-button">Neustart zu Einschalten benötigt</label><button id="disable-button" class="pure-button">WLAN Ausschalten</button>
									</div>
								</fieldset>
							</form>
						</div>
                    ...
                    <div class="pure-u-1 pure-u-md-1-2">
                        ...
                        <div class="box">
                            ...
                            <form class="pure-form pure-form-aligned">
                                <fieldset>
                                    <div class="pure-controls">
                                        <label for="wps-button">Wifi-Protected-Setup</label><button id="wps-button" class="pure-button">WPS Aktivieren</button>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
			...
			<div class="pure-u-24-24 section section-about">
				<div class="box">
					<h2>Ueber</h2>
					<p>Die Wortuhr basiert auf der Wortuhr von <a href="https://www.ulrichradig.de/home/index.php/projekte/wort-uhr-neu">Ulrich Radig</a> und wird entwickelt von <a href="https://github.com/Eisbaeeer">Lars Weimar</a>, <a href="https://github.com/Wandmalfarbe">Pascal Wagler</a>, <a href="https://github.com/dbambus">dbambus</a>, <a href="https://github.com/Flo455">Flo455</a>, <a href="https://github.com/Elektron79">Elektron79</a> und <a href="https://github.com/masju1">masju1</a>.</p>
