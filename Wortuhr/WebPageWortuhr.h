...
const char HTML_Code5[] PROGMEM= R"=====(
            ...
            <div class="pure-u-24-24 section section-smart_home">
                ...
                <div class="box">
                    <h2>Smart Home</h2>
                    <p>Die Software der Wordclock bietet die Möglichkeit der Steuerung über MQTT. Diese Funktion ist noch experiemtell und wird stetig erweitert.</p>
                </div>
                ...
                <div class="pure-u-1 pure-u-md-1-2">
                    ...
                    <div class="box">
                        ...
                        <form class="pure-form pure-form-aligned">
                            <fieldset>
                                <div class="pure-control-group">
                                    <label for="ssid">SSID</label><input id="mqtt_ssid" type="text" placeholder="SSID">
                                </div>
                                <div class="pure-control-group">
                                    <label for="password">Passwort</label><input id="mqtt_password" type="password" placeholder="Passwort">
                                </div>
                                <div class="pure-controls">
                                    <button id="mqtt-button" class="pure-button">WLAN speichern</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
                ...
                <div class="pure-u-1 pure-u-md-1-2">
                    ...
                    <div class="box">
                        ...
                        <form class="pure-form pure-form-aligned">
                            <fieldset>
                                <div class="pure-control-group">
                                    <label for="timeserver">Zeitserver</label><input id="mqtt_timeserver" type="text" placeholder="Zeitserver">
                                </div>
                                <div class="pure-controls">
                                    <button id="mqtt_timeserver-button" class="pure-button">Einstellungen speichern</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
