...
class De11x11schwaebisch_t : public ClockType {
public:
    ...
    virtual uint8_t numPixelsMinuteMatrix() override {
        return MINUTE_LED_COUNT;
    }
    ...
    virtual bool hasMinuteCorners() override { return true; }
