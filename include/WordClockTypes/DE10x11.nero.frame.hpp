...
public:
    virtual inline uint8_t numPixelsFrameMatrix() override { return 120; }

    //------------------------------------------------------------------------------

    virtual bool hasSecondsFrame() override { return true; }

    //------------------------------------------------------------------------------

    virtual uint16_t getFrameMatrixIndex(uint16_t index) override {
        return 114 + index;
    };
