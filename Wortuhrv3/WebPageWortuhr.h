					...
					<div class="pure-u-1 pure-u-md-1-2">
						...
						<form class="pure-form pure-form-aligned">
							<fieldset>
								...
								<div class="pure-control-group">
									<label for="ItIs15">Um 9:15 ist es...</label><select name="ItIs15" id="ItIs15" size="1">
									<option value="1" selected>viertel nach neun</option>
									<option value="2">viertel zehn</option>
								</select>
								</div>
								<div class="pure-control-group">
									<label for="ItIs20">Um 9:20 ist es...</label><select name="ItIs20" id="ItIs20" size="1">
									<option value="1" selected>zwanzig nach neun</option>
									<option value="2">zehn vor halb zehn</option>
								</select>
								</div>
								<div class="pure-control-group">
									<label for="ItIs40">Um 9:40 ist es...</label><select name="ItIs40" id="ItIs40" size="1">
									<option value="1" selected>zwanzig vor zehn</option>
									<option value="2">zehn nach halb zehn</option>
								</select>
								</div>
								<div class="pure-control-group">
									<label for="ItIs45">Um 9:45 ist es...</label><select name="ItIs45" id="ItIs45" size="1">
									<option value="1" selected>viertel vor zehn</option>
									<option value="2">dreiviertel zehn</option>
								</select>
								</div>
								<div class="pure-controls">
